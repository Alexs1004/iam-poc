# Overview — Mini IAM Lab (Archived)

> Archived for reference. Original document retained to preserve historical context; see updated recruiter-facing material in `../README.md`.
